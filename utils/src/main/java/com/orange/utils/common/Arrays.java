...
public class Arrays {
     ...
     *
     * <pre>
     * Arrays.realAdd(null, null)      = [null]
     * Arrays.realAdd(null, "a")       = ["a"]
     * Arrays.realAdd(["a"], null)     = ["a", null]
     * Arrays.realAdd(["a"], "b")      = ["a", "b"]
     * Arrays.realAdd(["a", "b"], "c") = ["a", "b", "c"]
     * </pre>
     *
     ...
     * Arrays.add(array1, null)   = copy of array1
     * Arrays.add(null, array2)   = copy of array2
     * Arrays.add([], [])         = []
